#grid = geometry manager that organizes widgest in a table-like structure in a parent
...
emailLabel = Label(window,text="Email: ",width=30,bg="blue").grid(row=2,column=0)
